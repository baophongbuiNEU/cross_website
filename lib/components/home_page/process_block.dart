              ...
              div(
                  ...
                  [
                    ...
                    CardProcessBlock(
                      index: "02",
                      title:
                          LanguageManager.translate('process_research_title'),
                      content:
                          LanguageManager.translate('process_research_content'),
                    ),
                    CardProcessBlock(
                      index: "03",
                      title: LanguageManager.translate(
                    ...
                    CardProcessBlock(
                      index: "04",
                      title:
                          LanguageManager.translate('process_monitoring_title'),
                      content: LanguageManager.translate(
                    ...
                    CardProcessBlock(
                      index: "05",
                      title:
                          LanguageManager.translate('process_reporting_title'),
                      content: LanguageManager.translate(
